...
class Handler(usercontrol):
	...
	def GTKForms(self):
		self.create("{'Name': 'Image1', 'Text': 'Image1', 'Top': '9', 'Left': '6', 'Width': '43', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[]', 'Tag': '', 'ParentsType': ''}","Image","usercontrol","[['clicked', 'self,e']]")
	def Widget(self):
